...
`~/.agents/skills/documandments/SKILL.md` (the general rules: the gate, the ladder, only-the-why)
and `~/.agents/skills/r2-sdlc-documentation-philosophy/SKILL.md` (the export doc-string bar and
your checklist). Every documentation finding should cite the relevant rule.
