...
export const STOPS = [
  ...
  { id: 'install',   band: 'run',    title: 'Install',             sub: 'five ways in, and what each gets you' },
  ...
  { id: 'templates', band: 'good',   title: 'Every template',      sub: 'decks, posters, dives, exchanges' },
