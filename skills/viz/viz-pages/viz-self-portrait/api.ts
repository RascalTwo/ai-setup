...
function readAxes(dir: string): Axes {
  try {
    ...
    return { posture: "untagged", listed: true, triaged: false, title: "", description: "", tags: [], scaffold: "" };
  }
}
...
export default {
  ...
  // Axis toggles (posture | listed | triaged) plus free-text frame metadata
  ...
  "/update": async (req: Request) => {
    ...
    for (const axis of ["posture", "listed", "triaged"]) {
