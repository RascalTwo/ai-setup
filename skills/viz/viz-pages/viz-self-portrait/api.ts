...
// The bundled container — the skill's own viz-pages/, holding this page and the built-in
// templates — is never written to the registry, so it is added here explicitly.
const BUNDLED = path.resolve(import.meta.dir, "..");
...
function readAxes(dir: string): Axes {
  try {
    ...
    return { posture: "untagged", listed: true, approval: "never" as const, title: "", description: "", tags: [], linkedFrom: [], kind: "", template: "", uid: "" };
  }
}
