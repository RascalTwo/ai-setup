...
const VALUE_FLAGS = new Set(["posture", "listed", "approved", "to", "access", "title", "description", "tags", "n"]);
...
const USAGE =
  ...
  "  bun manage.ts update <viz-folder> [--posture …] [--listed …] [--approved …] [--title …] [--description …] [--tags a,b,c]\n" +
