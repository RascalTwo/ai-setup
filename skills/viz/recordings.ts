...
// can never mistake a stale snapshot for live data. Pure HTML/CSS, no JS.
export function frozenBanner(recordedAt: string | null): string {
...
color:#78350f;background:#fde68a;border-bottom:1px solid #f59e0b;
text-align:center;letter-spacing:.02em;box-shadow:0 1px 4px rgba(0,0,0,.12)">
&#9208;&#65039; Frozen snapshot &middot; recorded ${age}</div>`;
}
