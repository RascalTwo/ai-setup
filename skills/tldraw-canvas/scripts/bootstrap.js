...
// Inject via mcp__claude-in-chrome__javascript_tool on any tldraw tab (tldraw.com
// or a self-hosted deployment) — it only needs window.editor.
...
(() => {
  if (!window.editor) {
    throw new Error('tldraw editor not found on window — this page is not a tldraw board, or has not finished loading');
  }
