...
# (use Read tool with offset/limit on ~/.agents/state/okta-api/spec-cache/management-minimal.yaml)
```

The spec is cached at `~/.agents/state/okta-api/spec-cache/management-minimal.yaml` and auto-refreshed after 7 days.
